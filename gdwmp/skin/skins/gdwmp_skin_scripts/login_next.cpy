...
# If a 'Proprietaire' logs in, find his folder to redirect to it.
from gdwmp.core.browser.propriofolder import findProprioFolder
proprioFolder = findProprioFolder(context)
if proprioFolder is not None:
    came_from = proprioFolder
