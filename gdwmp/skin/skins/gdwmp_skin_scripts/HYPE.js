	...
	this.addAdditionalCSS = function () {
		var additionalCSS = ".HYPE_element {\
			...
			@-webkit-keyframes HYPE_swapToFront {\
				0% {\
					-webkit-transform: translate3d(-232.75px, 0px, -600px) rotateY(50deg);\
					-webkit-animation-timing-function: ease-in;\
				}\
				50% {\
					-webkit-transform: translate3d(-465.5px, 0px, -300px) rotateY(40deg);\
			...
			@-webkit-keyframes HYPE_swapToBack {\
				...
				50% {\
					-webkit-transform: translate3d(465.5px, 0px, -300px) rotateY(-20deg);\
					-webkit-animation-timing-function: ease-out;\
				}\
			\
				100% {\
